...
def main():
    ...
    # Save the datasets
    print("\nSaving datasets...")
    np.save(os.path.join(output_dir, "test_parameters.npy"), parameters)
    np.save(os.path.join(output_dir, "test_solutions_full.npy"), solutions)
    np.save(os.path.join(output_dir, "test_solutions.npy"), misfits)

    print("\nDataset generation complete!")
    print(f"Files are saved in the '{output_dir}' directory as:")
    print("- test_parameters.npy")
    print("- test_solutions_full.npy")
    print("- test_solutions.npy")
