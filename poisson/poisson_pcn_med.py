...
"""
pCN sampling for the Poisson inverse problem — MEDIAN observation (data_50.npy).
...
Usage (10 serial trials):
    for i in $(seq 0 9); do
        python poisson_pcn_med.py --output_root pcn_median_100k --start_idx $i
    done

Usage (10 parallel trials via MPI):
    mpirun -n 10 python poisson_pcn_med.py --output_root pcn_median_100k
"""
...
parser = argparse.ArgumentParser(description="pCN chain — median observation")
parser.add_argument(
    "--output_root",
    type=str,
    required=False,
    default="pcn_median_100k",
