...
yobs = np.log(np.load("y_moderate.npy")) # This is evaluated on a finer mesh. Run the transport on the coarser mesh and this is still in distribution but not seen.
...
np.save("true_us_moderate_obs_2.npy", us)
