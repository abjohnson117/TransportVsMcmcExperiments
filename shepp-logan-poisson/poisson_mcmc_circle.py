...
if __name__ == "__main__":
    ...
    data_param = np.load(SL_DIR / 'data_sl.npy')
    data = data_param[:100]
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, "mcmc_mean_sl.png"))
